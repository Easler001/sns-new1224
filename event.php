...
<div class="main-visual">
  ...
  <p>
    ...
    <?php if (isset($error['event_name']) && $error['event_name'] === 'blank'): ?>
        ...
        <?php endif ?>
    <input type="text" size="60" name="name" value="<?php echo h($form['event_name']); ?>" placeholder=""/>
  </p>
